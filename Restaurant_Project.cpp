    ...
    {    // order file -> is file to display order of one customer
        ...
        if (f.is_open())
        {
            ...
            do
            {
                ...
                if(order.charge==-1)cout<<"** Item you want to buy not fount :( **\n ";
                else{ 
...
void DeleteRecord(int n)
{
    ...
    else if (n == 4)
    {
        ...
        if (in.is_open() && out.is_open())
        {
            ...
            if(!ok)cout<<"** Item you want to delete not found ** \n";
            in.close();
            out.close();
            remove("order.txt");
...
void UpdateRecord(int n)
{
    ...
    else if (n == 4)
    {
        ...
        if (in.is_open())
        {
            ...
            } if (!ok) cout << "** item you want to replace not found :( **\n";
            in.close();
            dispalyALLRecord(4);
        }
        else
    ...
    else if (n == 5)
    {
        ...
        if (file.is_open())
        {
            ...
            if (!found)
                cout << "There is no discounts on that product to update!";
            file.close();
        }
        else
        {
